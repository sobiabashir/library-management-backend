...
INSERT INTO categories (id, name) VALUES (5, 'Biography');
INSERT INTO categories (id, name) VALUES (6, 'Self Help');
INSERT INTO categories (id, name) VALUES (7, 'Philosophy');
INSERT INTO categories (id, name) VALUES (8, 'Psychology');
...
INSERT INTO authors (id, first_name, last_name, email) VALUES (4, 'Dale', 'Carnegie', 'dale@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (5, 'Walter', 'Isaacson', 'walter@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (6, 'Paulo', 'Coelho', 'paulo@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (7, 'Malcolm', 'Gladwell', 'malcolm@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (8, 'Frank', 'Herbert', 'frank@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (9, 'J.K.', 'Rowling', 'jk@example.com');
INSERT INTO authors (id, first_name, last_name, email) VALUES (10, 'Robert', 'Kiyosaki', 'robert@example.com');
...
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (5, 'How to Win Friends and Influence People', '978-0671027032', 1936, 4, 4, 6);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (6, 'Steve Jobs', '978-1451648539', 2011, 3, 5, 5);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (7, 'The Alchemist', '978-0062315007', 1988, 5, 6, 1);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (8, 'Outliers', '978-0316017930', 2008, 4, 7, 8);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (9, 'Dune', '978-0441013593', 1965, 3, 8, 10);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (10, 'Harry Potter and the Philosophers Stone', '978-0439708180', 1997, 6, 9, 1);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (11, 'Rich Dad Poor Dad', '978-1612680194', 1997, 5, 10, 9);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (12, 'Mans Search for Meaning', '978-0807014295', 1946, 4, 11, 7);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (13, 'The Brothers Karamazov', '978-0374528379', 1880, 2, 12, 1);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (14, 'Homo Deus', '978-0062464316', 2015, 4, 3, 3);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (15, 'The Tipping Point', '978-0316346627', 2000, 3, 7, 8);
INSERT INTO books (id, title, isbn, published_year, available_copies, author_id, category_id) VALUES (16, 'Leonardo da Vinci', '978-1501139154', 2017, 3, 5, 5);
...
INSERT INTO borrowing_records (id, borrow_date, return_date, status, book_id, member_id) VALUES (4, '2024-07-01', null, 'BORROWED', 2, 3);
INSERT INTO borrowing_records (id, borrow_date, return_date, status, book_id, member_id) VALUES (5, '2024-07-10', '2024-07-25', 'RETURNED', 7, 4);
